...
const Register = () => {
  return (
    <div className=" h-screen  bg-slate-200 flex items-center justify-center">
      <div className="flex flex-row-reverse w-1/2  min-h-[600px] rounded-md overflow-hidden ">
        <div className=" flex-1 p-12 bg-slate-400 flex flex-col gap-7 text-white ">
          ...
          <span className=" text-s "> Do you have an account?</span>
          <Link to="/login">
        ...
        <div className="flex-1 bg-white p-14 flex flex-col  gap-14 ">
          <h1 className="text-3xl font-semibold text-gray-400 ">Register</h1>
